...
![](https://github.com/hendraanggrian/IIT-CS487/raw/assets/assignments/proj2_draft_fig2.png)
...
Let's take a quick look at some historical examples of AI in the first
subsection. Finally, draw a comparison to other technologies in the
...
There are many technological breakthroughs throughout human history such as the
steam engine, the lightbulb, and the telephone. But perhaps none captivated the
public's fear like the invention of nuclear physics, especially in the 1950s
when it all began. It originated from the fear of the atomic bomb arms race
during the Cold War days.\[15\]

Today, nuclear energy amounts to almost one-fifth of the entire US energy
source.\[16\] Had we succumbed to the fear and stopped the advancement of
nuclear particles, society would be at the mercy of the coal industry. We are
now in a similar position with AI technology, where some prominent leaders are
pleading for a timeout.\[17\]
...
I do not own the image and the code in this paper, they are scrapped from
references and slightly modified.

## References

::: references
1. Buchanan, B. G. (2005). A (very) brief history of artificial intelligence. *Ai Magazine, 26*(4), 53-53.
2. Eberhart, R. C., & Dobbins, R. W. (1990). Early neural network development history: the age of Camelot. *IEEE Engineering in Medicine and Biology Magazine, 9*(3), 15-18.
3. Ram, B., & Pratima Verma, P. V. (2023). Artificial intelligence AI-based Chatbot study of ChatGPT, Google AI Bard and Baidu AI. *World Journal of Advanced Engineering Technology and Sciences, 8*(01), 258-261.
4. Liu, J., Xia, C. S., Wang, Y., & Zhang, L. (2023). Is your code generated by chatgpt really correct? rigorous evaluation of large language models for code generation. *arXiv preprint arXiv:2305.01210*.
5. Yetistiren, B., Ozsoy, I., & Tuzun, E. (2022, November). Assessing the quality of GitHub copilot’s code generation. In *Proceedings of the 18th International Conference on Predictive Models and Data Analytics in Software Engineering* (pp. 62-71).
...
7. Borji, A. (2022). Generated faces in the wild: Quantitative comparison of stable diffusion, midjourney and dall-e 2. *arXiv preprint arXiv:2210.00586*.
8. Meissner, G. (2020). Artificial intelligence: consciousness and conscience. *AI & SOCIETY, 35*, 225-235.
9. Cockburn, I. M., Henderson, R., & Stern, S. (2018). The impact of artificial intelligence on innovation: An exploratory analysis. In *The economics of artificial intelligence: An agenda* (pp. 115-146). University of Chicago Press.
10. Prince, J. (1980). Negligence: liability for defective software. *Okla. L. Rev., 33*, 848.
11. Kingston, J. K. (2016). Artificial intelligence and legal liability. In *Research and Development in Intelligent Systems XXXIII: Incorporating Applications and Innovations in Intelligent Systems XXIV 33* (pp. 269-279). Springer International Publishing.
12. Ryan, M. (2020). In AI we trust: ethics, artificial intelligence, and reliability. *Science and Engineering Ethics, 26*(5), 2749-2767.
...
14. Ars Technica: OpenAI and Microsoft announce extended, multi-billion-dollar partnership
15. Hogg, J. (2012). ‘The family that feared tomorrow’: British nuclear culture and individual experience in the late 1950s. *The British Journal for the History of Science, 45*(4), 535-549.
16. eia.gov: What is U.S. electricity generation by energy source?
17. Reuters: Elon Musk and others urge AI pause, citing 'risks to society'
:::
...
[15]: https://www.jstor.org/stable/pdf/41809789.pdf/
[16]: https://www.eia.gov/tools/faqs/faq.php?id=427&t=3
[17]: https://www.reuters.com/technology/musk-experts-urge-pause-training-ai-systems-that-can-outperform-gpt-4-2023-03-29/
